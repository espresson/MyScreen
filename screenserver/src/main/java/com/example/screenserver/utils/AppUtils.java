...
public class AppUtils {
   // private static final boolean DEBUG = BuildConfig.DEBUG;
    ...
    public static boolean isFastClick() {
        ...
        LogUtils.d("ToolsUtils", String.format("lastTime = %s", lastClickTime));
        return flag;
    }
    ...
    public static void installApk(Context context, File file, String authority) {
        ...
        //添加这一句表示对目标应用临时授权该Uri所代表的文件,7.0系统以上需要添加
...
//        }
    ...
    public static int isAppAlive(Context context,String packageName) {
        ActivityManager activityManager = (ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE);
        List<RunningTaskInfo> listInfos = activityManager.getRunningTasks(50);
        // 判断程序是否在栈顶
